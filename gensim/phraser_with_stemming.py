...
phrases = Phrases(contents,min_count=2,threshold=0.25, scoring='npmi',custom_bigrams=my_bigrams)
bigram = Phraser(phrases)
print "bigrams calculated"
tri_phase = Phrases(bigram[contents],min_count=2, threshold=0.25,scoring='npmi',custom_bigrams=my_bigrams)
