...
\begin{document}
	...
	\begin{itemize}
		...
		\item Focusing only on the features which are more descriptive than others.
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Extending the query document by adding rephrases of the key parts. For example, The query document \say {75 years old patient has rectal cancer } is extended to \say{ Elderly patient, $>$70 years old, The patient has rectal cancer, cancer in rectum }. The query document is generated in a structured way to allow an easy extension. The basic structure of the query document is ."Age, Gender, Type of cancer, Type of metastasis". 
		...
		\item The final results will be compared against the vanilla Doc2Vec model.
